...
// ListRegions - Lists all of the regions for the user that support workspaces
...
func (s *regions) ListRegions(ctx context.Context, request operations.ListRegionsRequest) (*operations.ListRegionsResponse, error) {
